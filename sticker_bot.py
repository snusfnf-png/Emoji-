...
def generate_plate_sticker(country: str, chars: str, region: str,
    ...
    """
    Рисует ТОЛЬКО номерной знак (белый прямоугольник с чёрной рамкой, флагом и текстом)
    на полностью прозрачном фоне. Никаких watermark, точек, серого фона.
    Рисуем в высоком разрешении (4× target_size), затем даунсемплируем — идеальное качество.
    """
